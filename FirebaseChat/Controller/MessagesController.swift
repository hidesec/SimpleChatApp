...
class MessagesController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = UIColor(r: 244, g: 248, b: 255)
    ...
    fileprivate func fetchMessageWithMessageId(_ messageId: String){
        let messagesPreference = Database.database().reference().child("messages").child(messageId)
        
        messagesPreference.observeSingleEvent(of: .value) { (snapshot) in
    ...
    func setupBarButton(){
        ...
        let rightBarButton = UIBarButtonItem(image: UIImage(named: "chat"), style: .plain, target: self, action: #selector(newMessage))
